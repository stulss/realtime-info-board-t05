...
OUT = ROOT / "docs" / "T05_과제_제출_보고서_2026-08-29.pptx"
if OUT.exists():
...
# 4. Architecture
s = base("ARCHITECTURE · 기존 경계를 보존한 최소 변경")
